...
async def SpamX_(SpamX: Client, message: Message):
    ...
    spamx_reply = "**__SpamX by AUJLA;__** \n\n"
    spamx_reply += "<=======================> \n"
    ...
    spamx_reply += "<=======================> \n\n"
    spamx_reply += "**Source Code:** [GitHub 🐈‍⬛](https://telegra.ph/file/8ffa51bb47619bb2ebb97.mp4) \n\n"
    spamx_reply += "**© @RiZoeLX** || Support: @PunjabiChat_Group"
